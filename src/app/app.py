...
df = pd.read_csv(
        "data/02_intermediate/season_standings_sim.csv"
    )
...
app.layout = html.Div([
    ...
    html.Div("This table shows the latest odds for winning the Premier League, finishing in the top 4, and relegation."),
